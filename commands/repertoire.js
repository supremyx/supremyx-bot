    ...
    fields: [
      {
        ...
        value: [
          ...
          '`!statistiques <équipe>` — Stats détaillées (points, kills, winrate)',
          ...
          '`!comparer <eq1> vs <eq2>` — Comparaison directe entre deux équipes',
    ...
    fields: [
      ...
      },
      {
        ...
        value: [
          ...
          '`!liste ajouter <équipe> @user <rôle>` — Ajoute un membre au roster',
          '`!liste role / !liste note` — Modifie les détails d\'un membre',
          '`!liste vider <équipe>` — Vide le roster d\'une équipe',
        ].join('\n'),
      },
    ],
  },
    ...
    fields: [
      {
        ...
        value: [
          ...
          '`!evenement creer` — Crée un événement RSVP (rejoindre/décliner)',
    ...
    fields: [
      {
        name: 'Commandes',
        value: [
          '`!annonce <message>` — Envoie une annonce officielle',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        name: 'Administration',
        value: [
          '`!donnerxp @user <montant>` — Ajoute de l\'XP à un membre',
          '`!retirerxp @user <montant>` — Retire de l\'XP',
          '`!progression [@user]` — Voir la progression XP d\'un membre',
          '`!definitrecompense <rang> @role` — Définit la récompense de rang',
          '`!synchroniserrangs` — Synchronise les rôles selon le classement',
        ].join('\n'),
      },
    ],
  },
    ...
    fields: [
      {
        ...
        value: [
          ...
          '`!tableaudebord` — Configure le tableau de bord automatique Discord',
    ...
    fields: [
      {
        ...
        value: [
          ...
          '`!misesajour` — Mises à jour du bot SUPREMYX (via GitHub)',
          '`!envoyergit` — Pousse les changements sur GitHub',
          '`!statutgit` — Statut du dépôt Git',
