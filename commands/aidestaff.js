...
const STAFF_CATEGORIES = [
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!latence',                description: 'Latence du bot et de l\'API Discord (temps de réponse en ms)', subs: [] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!ia coach <équipe>',               description: 'Plan tactique IA : analyse du style, plan de jeu, objectif (Staff)',  subs: ['coach <équipe> — Analyse tactique complète'] },
      { label: '!ia rotation <équipe>',            description: 'Plan de rotation IA : zone de drop, gestion des cercles (Staff)',      subs: ['rotation <équipe> — Stratégie de rotation optimisée'] },
      { label: '!ia riposte <équipe> vs <adversaire>', description: 'Contre-stratégie IA face à un adversaire (Staff)',               subs: ['riposte <mon équipe> vs <adversaire> — Plan de riposte détaillé'] },
