...
const STAFF_CATEGORIES = [
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!embed #salon | Titre | Desc | couleur',        description: 'Publier un embed texte dans un salon',          subs: ['preview | #salon | Titre | Desc | couleur — Prévisualiser avant publication', 'ici | Titre | Desc | couleur — Publier dans le salon courant'] },
      { label: '!embedbutton #salon | Titre | Desc | Texte >> https://... | couleur', description: 'Publier un embed avec boutons URL cliquables (max 5)', subs: ['preview | … — Prévisualiser avant publication'] },
      { label: '!embedlist [#salon]',                          description: 'Lister les embeds publiés par le bot dans un salon', subs: [] },
      { label: '!embededit #salon | ID | Titre | Desc | couleur', description: 'Modifier un embed déjà publié par le bot',       subs: ['ici | ID | Titre | Desc | couleur — Modifier dans le salon courant'] },
      { label: '!embedsupprimer #salon | ID_message',         description: 'Supprimer un embed publié par le bot (confirmation requise)', subs: ['ici | ID_message — Supprimer dans le salon courant'] },
      { label: '!embedplus <titre> | <desc> | [couleur] | [image_url] | [footer]', description: 'Poster un embed entièrement personnalisé dans le salon', subs: [] },
