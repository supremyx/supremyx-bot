...
const STAFF_CATEGORIES = [
  ...
  // ══ COMMANDES STAFF ════════════════════════════════════════════════════════
  {
    ...
    commands: [
      ...
      { label: '!embed complet #salon | Titre | Desc | couleur | image | thumbnail | auteur | auteur_icon | footer | url_titre | Bouton>>URL ; B2>>URL2 | Champ::Valeur::oui ; Champ2::Valeur2', description: 'Embed complet : thumbnail, auteur, image, boutons, champs, titre cliquable (Staff)', subs: ['complet aperçu | #salon | ... — Prévisualiser avant publication', 'complet modifier #salon | ID | Titre | Desc | couleur | image | thumbnail | auteur | auteur_icon | footer | url_titre | boutons | champs — Éditer un embed existant (`-` pour conserver un champ)', 'complet programmer #salon | ... | YYYY-MM-DD HH:MM — Planifier la publication'] },
