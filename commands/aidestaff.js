...
const STAFF_CATEGORIES = [
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!ia riposte <équipe> vs <adversaire>', description: 'Contre-stratégie IA face à un adversaire',               subs: ['riposte <mon équipe> vs <adversaire> — Plan de riposte détaillé'] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!antilink',                    description: 'Voir/configurer le filtre anti-liens et anti-invitations (Staff)', subs: ['activer / desactiver — Toggle', 'invites activer|desactiver — Blocage des invitations Discord', 'liens activer|desactiver — Blocage des liens externes', 'action <delete|delete_warn|delete_timeout> — Action appliquée', 'timeout <secondes> — Durée du timeout (10-86400)', 'seuil <nombre> — Seuil de violations avant sanction', 'domaine ajouter|retirer <domaine> — Liste blanche de domaines', 'exemptrole @role — Exempter un rôle', 'exemptchannel #salon — Exempter un salon'] },
      { label: '!antiraid',                    description: 'Voir/configurer la protection anti-raid (Staff)',                  subs: ['activer / desactiver — Toggle', 'seuil <nb_arrivées> <secondes> — Seuil de détection', 'age <jours> — Âge minimum du compte', 'action <alert|kick|ban|lockdown> — Action appliquée', 'debloquage <minutes> — Déverrouillage auto après lockdown', 'debloquer — Déverrouiller manuellement le serveur'] },
    ],
  },
  {
    id: 'tickets',
