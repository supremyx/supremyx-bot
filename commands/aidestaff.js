...
const STAFF_CATEGORIES = [
  ...
  // ══ COMMANDES STAFF ════════════════════════════════════════════════════════
  {
    ...
    commands: [
      ...
      { label: '!embed modèle sauvegarder <nom> | Titre | Desc | ...', description: 'Sauvegarder un embed comme modèle réutilisable (Staff)', subs: ['modèle charger <nom> | #salon — Publier un modèle dans un salon', 'modèle aperçu <nom> — Prévisualiser un modèle', 'modèle liste — Voir tous les modèles', 'modèle supprimer <nom> — Supprimer un modèle', 'modèle renommer <ancien> | <nouveau> — Renommer un modèle'] },
