...
const STAFF_CATEGORIES = [
  // ══ COMMANDES PUBLIQUES ════════════════════════════════════════════════════
  {
    ...
    color: 0x5865F2,
    commands: [
      { label: '!stats <équipe>',             description: 'Résumé complet des performances d\'une équipe',                     subs: [] },
      ...
      { label: '!comparer <T1> vs <T2>',      description: 'Comparer deux équipes ou deux joueurs côte à côte',                subs: ['<T1> vs <T2> — Stats équipes en direct', 'season <T1> vs <T2> — Comparaison historique des saisons', 'joueur <J1> vs <J2> — Comparer deux joueurs'] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!ia debriefing <équipe>',          description: 'Débrief post-match IA : résultat, forces, faiblesses, objectifs', subs: ['debriefing <équipe> — Analyse du dernier match', 'debriefing salon #salon — Configurer le canal auto *(Admin)*', 'debriefing desactiver — Désactiver le débrief auto *(Admin)*', 'debriefing statut — Voir la configuration'] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!podium',                       description: 'Top 3 équipes du tournoi actif',                                 subs: [] },
  ...
  // ══ COMMANDES STAFF ════════════════════════════════════════════════════════
  {
    ...
    commands: [
      ...
      { label: '!sondage <durée> <question> | <opt1> | <opt2>', description: 'Sondage immédiat avec options multiples et résultats auto (Staff)', subs: [
        ...
        'prog liste — Voir tous les sondages programmés',
      ...
      { label: '!embed envoyer [preview] #salon | Titre | Desc | couleur', description: 'Publier un embed dans un salon (Staff)', subs: ['envoyer ici | Titre | Desc | couleur — Dans le salon courant'] },
      { label: '!embed boutons [preview] #salon | Titre | Desc | Texte >> https://...', description: 'Embed avec boutons URL cliquables max 5 (Staff)', subs: ['boutons preview | … — Prévisualiser avant publication'] },
      ...
      { label: '!embed riche #salon | Titre | Desc | couleur | image | thumbnail | auteur', description: 'Embed complet : thumbnail, auteur, image, liens hypertextes (Staff)', subs: ['embed riche preview | #salon | ... — Prévisualiser avant publication'] },
      { label: '!embed liste [#salon]',       description: 'Lister les embeds publiés par le bot dans un salon (Staff)',        subs: [] },
      { label: '!embed modifier #salon | ID | Titre | Desc', description: 'Modifier un embed déjà publié par le bot (Staff)',   subs: ['modifier ici | ID | Titre | Desc | couleur — Dans le salon courant'] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!salonsoumissionlogos #salon',  description: 'Définir le salon de dépôt de logos d\'équipes (Staff)',           subs: [] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!journal [N]',                description: 'N derniers commits Git (alias : !misesajour) (Staff)',             subs: [] },
      { label: '!tableaudebord',              description: 'Générer et accéder au tableau de bord web (Staff)',                subs: [] },
      { label: '!gitpush',                    description: 'Pousser le code vers GitHub (Staff)',                              subs: [] },
      { label: '!gitstatus',                  description: 'Voir le statut du dépôt Git (Staff)',                              subs: [] },
    ],
  },
  {
    id: 'erreurs',
