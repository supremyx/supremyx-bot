...
const STAFF_CATEGORIES = [
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!evenement creer <titre> | [desc] | [date]', description: 'Créer un événement RSVP avec réactions ✅/❌', subs: ['creer <titre> | [desc] | [date] — Créer', 'annuler <id> — Annuler un événement'] },
      ...
      { label: '!infolettre salon #salon',          description: 'Infolettre hebdo automatique (dimanche 20h)',        subs: ['salon #salon — Configurer', 'activer|desactiver — Toggle', 'tester — Envoyer maintenant', 'statut — Voir config'] },
      ...
      { label: '!listedattente configurer',         description: 'Gérer la liste d\'attente d\'inscription au tournoi', subs: ['configurer | config #salon <max> <rolId> [rolVip] [titre] — Configurer', 'initialiser — Réinitialiser les inscriptions', 'liste — Voir toutes les inscriptions en attente', 'confirmer <équipe> — Confirmer une inscription', 'retirer <équipe> — Retirer une équipe de la liste', 'vip <équipe> — Marquer une équipe en priorité VIP', 'places <N> — Modifier le nombre de places disponibles', 'réinitialiser — Vider complètement la liste', 'infos — Voir la configuration et statistiques'] },
    ],
  },
  {
    id: 'equipes',
    ...
    commands: [
      ...
      { label: '!configlogo <équipe> | <url>', description: 'Définir le logo/thumbnail d\'une équipe (URL image)', subs: ['<équipe> | supprimer — Retirer le logo'] },
      { label: '!transfert <joueur> | <ancienne> | <nouvelle>', description: 'Déplacer un joueur d\'une équipe à une autre', subs: [] },
      { label: '!reinitjoueur <équipe> <nom>', description: 'Remettre les stats d\'un joueur à zéro',           subs: [] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!definitrecompense <rang> @role', description: 'Rôle Discord selon le rang au classement',         subs: [] },
      ...
      { label: '!synchroniserrangs',              description: 'Synchroniser tous les rôles de rang',               subs: [] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!configsuggestion #salon',   description: 'Configurer le salon de réception des suggestions', subs: [] },
      { label: '!acceptersugg <id> [note]', description: 'Accepter une suggestion et notifier l\'auteur',   subs: [] },
      { label: '!rejetersugg <id> [note]',  description: 'Rejeter une suggestion avec note facultative',     subs: [] },
      ...
      { label: '!configmdj <texte>',          description: 'Définir le message du jour automatique',      subs: [] },
      ...
      { label: '!embed programmer #salon | Titre | Desc | couleur | YYYY-MM-DD HH:MM', description: 'Programmer la publication d\'un embed à une date précise', subs: [] },
      { label: '!embed programmes',                                    description: 'Voir tous les embeds programmés en attente sur ce serveur', subs: [] },
      { label: '!embed déprogrammer <id>',                             description: 'Annuler un embed programmé avant sa publication', subs: [] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!definitpoints <placement>',    description: 'Configurer le barème de points',                    subs: [] },
      ...
      { label: '!salonanniversaires #salon',    description: 'Salon des annonces d\'anniversaire',                subs: [] },
      { label: '!salonniveaux #salon',          description: 'Salon des montées de niveau XP',                    subs: [] },
      ...
      { label: '!salonsoumissionlogos #salon',   description: 'Définir le salon de dépôt de logos d\'équipes',    subs: [] },
      { label: '!salonaffichagelogos [#salon]',  description: 'Voir les logos soumis dans un salon',               subs: [] },
      { label: '!voirconfig',                    description: 'Vue d\'ensemble de toute la configuration serveur',  subs: [] },
      { label: '!configdelai <commande> <sec>', description: 'Modifier le cooldown d\'une commande',              subs: ['delais — Voir tous les cooldowns', 'supprimerdelai <commande> — Réinitialiser'] },
    ],
  },
  {
    id: 'moderation',
    ...
    commands: [
      ...
      { label: '!topavertissements',            description: 'Top 10 membres les plus sanctionnés',             subs: [] },
    ],
  },
  {
    id: 'escalade',
