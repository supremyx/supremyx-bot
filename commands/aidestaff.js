...
const STAFF_CATEGORIES = [
  // ══ COMMANDES PUBLIQUES ════════════════════════════════════════════════════
  {
    ...
    commands: [
      ...
      { label: '!classement',                 description: 'Classement général des équipes',                                    subs: ['eliminations — Classement par total d\'éliminations', 'ratio — Classement par kills/match', 'elo — Classement ELO (performance pondérée)', 'semaine — Classement de la semaine en cours', '<tournoi> — Classement filtré sur un tournoi'] },
      ...
      { label: '!elo <équipe>',              description: 'Score ELO d\'une équipe (placement + kills pondérés par recence)',   subs: [] },
      { label: '!classementelo',             description: 'Classement ELO global de toutes les équipes avec tendance',         subs: [] },
      { label: '!statsserveur',              description: 'Statistiques globales du serveur : matchs, kills, records, activité', subs: [] },
      { label: '!rivaux <équipe>',           description: 'Rivaux d\'une équipe : adversaires récurrents et comparaison H2H',  subs: [] },
      { label: '!record <équipe>',           description: 'Records d\'une équipe : max kills, meilleur placement, meilleures séries', subs: ['<équipe> — Records de l\'équipe', 'joueur <nom> — Records personnels d\'un joueur'] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!matchjoueur <équipe> <joueur> <kills>',       description: 'Enregistrer les kills d\'un joueur sur le dernier match (Staff)', subs: [] },
      ...
      { label: '!absence toutes',                               description: 'Voir toutes les absences déclarées sur le serveur (Staff)', subs: [] },
      ...
      { label: '!absence effacer @membre',                     description: 'Effacer l\'absence d\'un joueur (Staff)',               subs: ['effacer @membre — Effacer l\'absence d\'un joueur'] },
      ...
      { label: '!draftequipe [N]',                            description: 'Répartir les agents libres en N équipes équilibrées par snake draft (Staff)', subs: [] },
      { label: '!badge donner @membre <emoji> <nom>',         description: 'Attribuer un badge personnalisé à un joueur (Staff)', subs: ['donner @membre <emoji> <nom> [desc] — Attribuer', 'retirer @membre <nom> — Retirer', 'liste [@membre] — Voir les badges'] },
      { label: '!capitaines',                                 description: 'Liste de tous les capitaines (IGL) de toutes les équipes', subs: [] },
      { label: '!badges',                                     description: 'Galerie de tous les badges distribués sur le serveur', subs: [] },
      { label: '!badge liste [@membre]',                      description: 'Voir les badges d\'un joueur ou tous les badges du serveur', subs: ['liste — Tous les badges du serveur', 'liste @membre — Badges d\'un joueur', 'liste <nom> — Badges par nom de joueur'] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!ia debrief <équipe>',             description: 'Débrief post-match IA : résultat, forces, faiblesses, objectifs', subs: ['debrief <équipe> — Analyse du dernier match', 'debrief salon #salon — Configurer le canal auto (Staff)', 'debrief desactiver — Désactiver le débrief auto (Staff)', 'debrief statut — Voir la configuration'] },
      { label: '!ia coach <équipe>',               description: 'Plan tactique IA : analyse du style, plan de jeu, objectif',  subs: ['coach <équipe> — Analyse tactique complète'] },
      { label: '!ia rotation <équipe>',            description: 'Plan de rotation IA : zone de drop, gestion des cercles',      subs: ['rotation <équipe> — Stratégie de rotation optimisée'] },
      { label: '!ia riposte <équipe> contre <adversaire>', description: 'Contre-stratégie IA face à un adversaire',               subs: ['riposte <mon équipe> contre <adversaire> — Plan de riposte détaillé'] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!aide historique',               description: 'Voir l\'historique de tes 5 dernières recherches dans !aide',      subs: [] },
  ...
  // ══ COMMANDES STAFF ════════════════════════════════════════════════════════
  {
    ...
    commands: [
      ...
      { label: '!dire [#salon] <message>',    description: 'Faire parler le bot dans le salon courant ou un salon mentionné — supporte les pièces jointes (Staff)', subs: [] },
      ...
      { label: '!planifier creer',            description: 'Créer un message planifié récurrent ou ponctuel (Staff)',           subs: ['creer — Créer', 'liste — Voir messages', 'voir <id> — Détails d\'un message planifié', 'supprimer <id> — Supprimer', 'modifier <id> — Modifier', 'dupliquer <id> — Dupliquer', 'pause <id> — Mettre en pause', 'tester <id> — Tester maintenant'] },
      ...
      { label: '!embed simple [aperçu] #salon | Titre | Desc | couleur', description: 'Publier un embed simple dans un salon (Staff)', subs: ['simple ici | Titre | Desc | couleur — Dans le salon courant', 'simple aperçu | #salon | ... — Prévisualiser avant publication'] },
      { label: '!embed boutons [aperçu] #salon | Titre | Desc | Texte >> https://... | Texte2 >> https://...', description: 'Embed avec boutons URL cliquables, jusqu\'à 25 boutons sur 5 rangées (Staff)', subs: ['boutons aperçu | … — Prévisualiser avant publication'] },
      { label: '!embed riche [aperçu] #salon | Titre | Desc | couleur | image | footer', description: 'Embed avec image et footer, choix du salon (Staff)', subs: ['riche ici | Titre | Desc | couleur | image | footer — Dans le salon courant', 'riche aperçu | #salon | ... — Prévisualiser avant publication'] },
      { label: '!embed complet #salon | Titre | Desc | couleur | image | thumbnail | auteur | auteur_icon | footer | footer_icon | url_titre | Bouton>>URL ; B2>>URL2 | Champ::Valeur::oui ; Champ2::Valeur2', description: 'Embed complet : thumbnail, auteur, image, footer avec icône, boutons, champs, titre cliquable (Staff)', subs: ['complet aperçu | #salon | ... — Prévisualiser avant publication', 'complet modifier #salon | ID | Titre | Desc | couleur | image | thumbnail | auteur | auteur_icon | footer | footer_icon | url_titre | boutons | champs — Éditer un embed existant (`-` pour conserver un champ)', 'complet programmer #salon | ... | YYYY-MM-DD HH:MM — Planifier la publication'] },
      { label: '!embed modèle sauvegarder <nom> | Titre | Desc | ...', description: 'Sauvegarder un embed comme modèle réutilisable (Staff)', subs: ['modèle charger <nom> | #salon — Publier un modèle dans un salon', 'modèle aperçu <nom> — Prévisualiser un modèle', 'modèle liste — Voir tous les modèles', 'modèle supprimer <nom> — Supprimer un modèle', 'modèle renommer <ancien> | <nouveau> — Renommer un modèle', 'modèle dupliquer <nom> | <nouveau_nom> — Cloner un modèle existant'] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!configdelai <commande> <sec>', description: 'Modifier le cooldown d\'une commande en secondes (Staff)',       subs: [] },
      { label: '!delais',                      description: 'Voir tous les cooldowns configurés sur ce serveur (Staff)',        subs: [] },
      { label: '!supprimerdelai <commande>',   description: 'Réinitialiser le cooldown d\'une commande à sa valeur par défaut (Staff)', subs: [] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!mot ajouter <mot>',           description: 'Gérer les mots interdits dans le filtre (Staff)',                 subs: ['ajouter <mot> — Ajouter un mot interdit', 'retirer <mot> — Retirer un mot', 'defaut — Restaurer la liste par défaut', 'vider — Vider toute la liste'] },
      { label: '!mots',                        description: 'Voir la liste complète des mots interdits configurés (Staff)',      subs: [] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!journaux',                   description: 'Historique des actions staff avec filtres (Staff)',                subs: ['vider — Effacer tout', 'statistiques — Statistiques par catégorie', 'aujourdhui — Logs du jour', '<catégorie> [page] — Filtrer par catégorie', '<mot-clé> — Recherche plein texte'] },
  ...
  },
  {
    ...
    color: 0xED4245,
    commands: [
      { label: '!erreurs',                       description: 'Consulter les dernières erreurs du bot (Staff)',                 subs: ['nonresolues — Erreurs non résolues', 'statistiques — Statistiques globales', 'resoudre <id> — Marquer résolue', 'vider — Effacer tout'] },
