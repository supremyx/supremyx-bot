...
const STAFF_CATEGORIES = [
  // ══ COMMANDES PUBLIQUES ════════════════════════════════════════════════════
  {
    ...
    commands: [
      ...
      { label: '!sauvegarde',                 description: 'Créer et gérer les sauvegardes JSON complètes (Staff)',             subs: ['creer — Créer une nouvelle sauvegarde', 'liste — Voir toutes les sauvegardes', 'info <id> — Détails d\'une sauvegarde', 'supprimer <id> — Supprimer une sauvegarde', 'auto activer|desactiver <h> — Activer la sauvegarde automatique', 'canal #salon — Salon d\'envoi auto', 'statut — Voir la configuration auto'] },
