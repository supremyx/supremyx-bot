...
const CATEGORIES = [
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!infouser [@membre]',    description: 'Infos Discord d\'un membre : niveau, rôles, sanctions',      subs: [] },
      { label: '!inforole @role',        description: 'Détails d\'un rôle Discord (membres, permissions, couleur)', subs: [] },
      { label: '!serveur',               description: 'Informations générales sur le serveur',                       subs: [] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!event creer',             description: 'Créer un événement RSVP',                    subs: ['creer <titre> | <desc> | <date> — Créer *(staff)*', 'liste — Voir les événements', 'joindre <id> — S\'inscrire', 'quitter <id> — Décliner', 'participants <id> — Voir participants', 'annuler <id> — Annuler *(staff)*'] },
