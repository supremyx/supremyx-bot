...
const CATEGORIES = [
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!succes [@membre]',          description: 'Voir les succès et trophées de progression débloqués par un membre', subs: [] },
  ...
  },
  {
    ...
    commands: [
      ...
      { label: '!ia debrief <équipe>',    description: 'Débrief post-match IA : analyse, points forts/faibles, objectifs', subs: ['debrief <équipe> — Débrief du dernier match', 'debrief statut — Voir le canal auto configuré'] },
