      ...
      .addFields(
        {
          ...
          value: [
            ...
            '`!roster <équipe>` — Composition / roster d\'une équipe',
            '`!recherche <nom>` — Rechercher une équipe ou un joueur',
            '`!statsjoueur <nom>` — Stats détaillées d\'un joueur',
          ].join('\n'),
          inline: false,
        },
        {
          ...
          value: [
            ...
            '`!inscrire <nom_équipe>` — Inscrire son équipe à un tournoi ouvert',
        ...
        },
        {
          ...
          value: [
            ...
            '`!infouser [@membre]` — Infos, niveau et avertissements d\'un membre',
      ...
      .addFields(
        ...
        },
        {
          ...
          value: [
            ...
            '`!sanctions [@membre]` — Voir ses propres sanctions (ou celles d\'un membre)',
